...
<head>
  ...
  <!-- Bootstrap core CSS -->
  <link href="{{ asset('FrondEnd') }}/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">
...
<body>
  ...
  <!-- Page Header -->
  <header class="masthead" style="background-image: url('{{ asset('FrondEnd') }}/img/home-bg.jpg')">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-8 col-md-10 mx-auto">
          ...
          <p class="copyright text-muted">&copy; Mamun Hossain <?=date('Y')?></p>
        </div>
      </div>
    </div>
  </footer>
